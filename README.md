# gotham-science
[![Published on npm](https://img.shields.io/npm/v/@gotham/gotham-science.svg?style=flat)](https://www.npmjs.com/package/@gotham/gotham-science)
[![Build Status](https://travis-ci.org/heyMP/gotham-science.svg?branch=master)](https://travis-ci.org/heyMP/gotham-science)
[![Dependency Status](https://img.shields.io/david/heyMP/gotham-science.svg?style=flat)](https://david-dm.org/heyMP/gotham-science)
...
Welcome to the gotham-science project!
...
```bash
$ git clone git@github.com:heyMP/gotham-science.git
$ cd gotham-science
$ yarn install
$ yarn start
```
...
- `$ yarn test`
    -  Run tests on ALL gotham-science.
- `$ yarn run build`
    -  Run build on ALL gotham-science.
- `$ yarn run storybook`
    - Run storybook
- `$ yarn run build-storybook`
    - Build storybook for deployment
- `$ lerna publish`
    - Publish ALL gotham-science' elements to npmjs.com
...
To test all gotham-science, run `yarn test` from the root of the repo. If you only want to test the web component you're working on:
...
Then open the URL that will be printed in the terminal. It looks something like this: `http://localhost:8081/components/@@gotham/gotham-science/generated-index.html?cli_browser_id=0`.

## Storybook

We've added [Storybook](https://storybook.js.org/) to gotham-science as a way to preview our web components as they are being developed. We'll also use Storybook to export a static site that will be the demo site for gotham-science.
...
```js
"../../whatwg-fetch/fetch.js": path.join( // this is the third-party dependency in the gotham-science
  __dirname,
